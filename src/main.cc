...
int main(int argc, char **argv)
{
    ...
    nh_priv.param<double>("max_accel", max_accel, 1.0);
    ...
    robot = boost::make_shared<Robot>(driver_left, driver_right, robot_radius, wheel_radius, max_accel);
    ROS_INFO("Running.");
